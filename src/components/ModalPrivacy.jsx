  ...
  return (
    <Modal show={show} onHide={onHide} size="lg">
      ...
      <Modal.Body>
        ...
        <p>
          Provide collection services, process payment for our services, or for
          any other purpose that you authorise.
        </p>

        <p>Besides our staff, we share this information with:</p>
        <p>Our IT providers in order to manage the collections and payments.</p>
        ...
        <p>
          ...
          wrong. There may be a reasonable charge for this.
        </p>
        <p>
          If you&apos;d like to ask for a copy of your information, or to have
          it corrected, please contact us at service@redlid.co.nz, or 0800
          REDLID (0800 733543), or P.O. Box 24087, Hillcrest, Hamilton 3253.
        </p>
      </Modal.Body>
      <Modal.Footer>
